...
- **Undo only sees local draft changes (US-123 → US-130)**: `Deshacer` after
  deleting a connection compares the dashboard's current draft object with the
