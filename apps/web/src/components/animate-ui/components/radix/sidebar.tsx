...
function SidebarProvider({
  ...
  // openProp and setOpenProp can control it from outside.
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      if (typeof document !== "undefined") {
        // biome-ignore lint/suspicious/noDocumentCookie: vendored animate-ui sidebar state persistence
  ...
  // Keyboard shortcut to toggle the sidebar (Cmd+B or Ctrl+B).
  React.useEffect(() => {
    ...
    <HighlightItem activeClassName="bg-sidebar-accent text-sidebar-accent-foreground rounded-md">
      <Comp
        ...
        className={cn(
          ...
          "data-[active=true]:bg-sidebar-accent data-active:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground data-active:text-sidebar-accent-foreground",
          size === "sm" && "text-xs",
          size === "md" && "text-sm",
          "group-data-[collapsible=icon]:hidden",
          className,
