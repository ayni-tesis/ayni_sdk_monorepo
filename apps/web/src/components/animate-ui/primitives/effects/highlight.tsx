...
type HighlightContextType<T extends string = string> = {
        ...
        ? controlledItems
          ...
          : render(
              React.Children.map(children, (child, index) => (
                // biome-ignore lint/suspicious/noArrayIndexKey: Primitive fallback index key
...
function HighlightItem<T extends React.ElementType = "div">({
  ...
  const isElementValid = React.isValidElement(children);
  const element = (
    isElementValid ? children : null
  ) as React.ReactElement<ExtendedChildProps> | null;
